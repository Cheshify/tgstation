...
<<<<<<< HEAD
	...
	desc_by_access["[ACCESS_LAWYER]"] = "Sophont Resources Office" // DOPPLER EDIT CHANGE - Security Lore Rework - Original: desc_by_access["[ACCESS_LAWYER]"] = "Law Office"
	...
	desc_by_access["[ACCESS_HOS]"] = "CG Office" // DOPPLER EDIT CHANGE - Security Lore Rework - Original: desc_by_access["[ACCESS_HOS]"] = "HoS Office"
